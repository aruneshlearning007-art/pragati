export const UI = {
  en: {
    ...
    concept: "Concept",
    examFormatCta: "Exam Format",
    examFormatTitle: "Exam Paper Format",
    examFormatSubtitle: "Define the exam structure once for a subject and class — every chapter in it reuses this.",
    examFormatSubjectClassBoard: "Subject, class & board",
    examFormatDurationLabel: "Duration (minutes)",
    examFormatSectionsTitle: "Sections",
    examFormatSectionLabel: "Section label",
    examFormatSectionLabelPlaceholder: "e.g. Fill in the Blanks",
    examFormatKindLabel: "Question type",
    examFormatKindFillBlank: "Fill in the Blank",
    examFormatKindTrueFalse: "True / False",
    examFormatKindMcq: "Multiple Choice",
    examFormatKindSubjective: "Short / Long Answer",
    examFormatCountLabel: "Questions",
    examFormatMarksLabel: "Marks each",
    examFormatAddSection: "+ Add section",
    examFormatRemoveSection: "Remove",
    examFormatTotalMarks: "Total marks",
    examFormatSaveDraft: "Save as draft",
    examFormatPublish: "Publish",
    examFormatSaved: "Saved as draft.",
    examFormatPublished: "Published — teachers and students can now download exam papers for this subject/class.",
    examFormatLoadedExisting: "Editing the existing format for this subject/class.",
    mockExamTitle: "Mock Exam",
    mockExamSubtitle: "Practice with an exam-style paper for this chapter.",
    mockExamSetBeginner: "Set 1 · Beginner",
    mockExamSetIntermediate: "Set 2 · Intermediate",
    mockExamSetAdvance: "Set 3 · Advance",
    mockExamQuestionPaper: "Question Paper",
    mockExamAnswerKey: "Answer Key",
    ...
    practiceModeWordProblems: "Word Problems",
    difficultyEasy: "Easy",
    ...
    conceptsMasteredSuffix: "concepts mastered",
  ...
  hi: {
    ...
    concept: "विषय-वस्तु",
    examFormatCta: "परीक्षा प्रारूप",
    examFormatTitle: "परीक्षा पत्र प्रारूप",
    examFormatSubtitle: "एक विषय और कक्षा के लिए परीक्षा संरचना एक बार तय करें — उस विषय का हर अध्याय इसे उपयोग करेगा।",
    examFormatSubjectClassBoard: "विषय, कक्षा और बोर्ड",
    examFormatDurationLabel: "अवधि (मिनट)",
    examFormatSectionsTitle: "खंड",
    examFormatSectionLabel: "खंड का नाम",
    examFormatSectionLabelPlaceholder: "जैसे रिक्त स्थान भरें",
    examFormatKindLabel: "प्रश्न प्रकार",
    examFormatKindFillBlank: "रिक्त स्थान भरें",
    examFormatKindTrueFalse: "सही या गलत",
    examFormatKindMcq: "बहुविकल्पीय",
    examFormatKindSubjective: "लघु / दीर्घ उत्तर",
    examFormatCountLabel: "प्रश्नों की संख्या",
    examFormatMarksLabel: "प्रति प्रश्न अंक",
    examFormatAddSection: "+ खंड जोड़ें",
    examFormatRemoveSection: "हटाएं",
    examFormatTotalMarks: "कुल अंक",
    examFormatSaveDraft: "ड्राफ्ट के रूप में सहेजें",
    examFormatPublish: "प्रकाशित करें",
    examFormatSaved: "ड्राफ्ट के रूप में सहेजा गया।",
    examFormatPublished: "प्रकाशित — शिक्षक और छात्र अब इस विषय/कक्षा के लिए परीक्षा पत्र डाउनलोड कर सकते हैं।",
    examFormatLoadedExisting: "इस विषय/कक्षा के मौजूदा प्रारूप को संपादित किया जा रहा है।",
    mockExamTitle: "मॉक परीक्षा",
    mockExamSubtitle: "इस अध्याय के लिए परीक्षा-शैली के पत्र से अभ्यास करें।",
    mockExamSetBeginner: "सेट 1 · शुरुआती",
    mockExamSetIntermediate: "सेट 2 · मध्यम",
    mockExamSetAdvance: "सेट 3 · उन्नत",
    mockExamQuestionPaper: "प्रश्न पत्र",
    mockExamAnswerKey: "उत्तर कुंजी",
    ...
    practiceModeWordProblems: "शब्द समस्याएँ",
    difficultyEasy: "आसान",
    ...
    conceptsMasteredSuffix: "विषय-वस्तु पूर्ण",
